...
// Manual configuration (production / SSR / CI). For local development with the
// MACHHUB Designer VS Code extension, you can call sdk.Initialize() with no args.
...
If you install the [MACHHUB Designer](/designer/overview/) VS Code extension, it
detects your local server and supplies these connection details automatically — so
in development you can simply call `await sdk.Initialize()`.
:::
