...
| Setting | Notes |
| --- | --- |
| `app.port` | The REST API / console port (commonly `80`). |
...
| `data_storage` | Configured for time-series; note the Historian is currently implemented on SurrealDB in this build. |
